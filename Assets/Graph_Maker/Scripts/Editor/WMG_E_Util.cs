...
//	}
	...
	public void ExposeProperty(PropertyField field, string tooltip = "")
	{
	...
	public void ExposeEnumMaskProperty(PropertyField field) {
		var emptyOptions = new GUILayoutOption[0];
		var oldValue = (Enum)field.GetValue();
	...
	public Dictionary<string, PropertyField> GetProperties(object obj)
	{
		Dictionary<string, PropertyField> fields = new Dictionary<string, PropertyField>();
